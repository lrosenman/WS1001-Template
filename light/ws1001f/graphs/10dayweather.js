    ...
    function a(a) {
        if (0 === typeof a.length) s("forecast");
            ...
            for (var e = 0; e < a.length; e++) {
				...
				n.high.fahrenheit + "° | <span style='color:#66a1ba;font-size:12px;'> " + n.low.fahrenheit + "° <div class='rain'> <span style='color:#777;font-size:11px;font-weight:900;margin-left:17%;'> " + 
				...
				n.snow_allday.in + " <span style='color:#66a1ba;font-size:11px;font-weight:900;'> in <br><span style='color:#777;font-size:10px;margin-left:17%;'>" +
