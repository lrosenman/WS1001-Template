...
else if($temp_c<35){echo "<div class=\"freezing\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<40){echo "<div class=\"cold\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<45){echo "<div class=\"gettingcolder\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<50){echo "<div class=\"colder\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<60){echo "<div class=\"cooler\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<70){echo "<div class=\"milder\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<80){echo "<div class=\"gettingcooler\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<85){echo "<div class=\"warm\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<90){echo "<div class=\"warmer\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<95){echo "<div class=\"hot\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<100){echo "<div class=\"hotter\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<105){echo "<div class=\"hotter\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<110){echo "<div class=\"veryhot\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}
else if($temp_c<155){echo "<div class=\"extremehot\"></div><div class=\"temptext\">${temp_c}<suptemp>&deg;</suptemp></div>";}?>
</div><!-- end animated temperature for homeweather station-->    
<div class="max">Feels 
<?php echo "";
...
<div class="temptrend">
<?php
// for WS1001 clones compares the reading from 6 minutes ago(based on the stationcron update and compares it to the current realtime reading //
//echo $trendTemp;
if ($temp_c === $trendTemp) {
...
<div class="heatcircle-content">Dewpoint <br><span style="color:#66a1ba;font-weight:600;"><?php echo "${dewpoint_c}${templateunit}\n"; ?>
