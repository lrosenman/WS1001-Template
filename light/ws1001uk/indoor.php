...
<div class="tempcontainer1"><div class="circleOut">
  ...
  <?php echo "Indoor \n"?>
<?php echo " ${temp_indoor}&deg;</span> \n";if($temp_indoor>0){echo "<div class=\"\"></div><div class=\"temptext1\"> ${temp_indoor}<suptemp1>&deg;</suptemp1></div>";}
else if($temp_indoor<50){echo "<div class=\"\"></div><div class=\"temptext1\"> ${temp_indoor}<suptemp1>&deg;</suptemp1></div>";}
