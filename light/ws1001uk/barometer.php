...
$("#circularGaugeContainer").dxCircularGauge({
  rangeContainer: { 
   width: 8,
    ...
    ranges: [
     ...
     { startValue: 960, endValue:<?php print "${barometer}"?>,  color: 'rgba(242,108,79,0.8)'},
  ...
  scale: {
    ...
    majorTick: { tickInterval: 10, visible: true, color: 'rgba(255,255,255,0.1)'},
	minorTick: {color: 'rgba(255,255,255,0.1)',visible: true,minorTickInterval: 5},
	label: {
	format: '',
	font:{size:10},
