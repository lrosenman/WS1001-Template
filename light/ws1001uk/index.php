 ...
 <i class="fa fa-map-marker1 fa-1x"></i> <span><?php echo "${stationName} \n";?> <br>WEATHER STATION</span> 
	...
	<div class="weather-container">
		<div class="weather-item">
			...
			</div><span style="font-size:11px;font-weight:600;text-transform:uppercase;color:rgba(95,96,97,0.8)">Temperature <?php echo "${templateunit} \n";?><br></span>
		...
		<div class="weather-item">
			...
			</div><span style="font-size:11px;font-weight:600;text-transform:uppercase;color:rgba(95,96,97,0.8)"><i class="fa fa-map-marker"></i> <?php echo "${stationlocation} \n";
			?>Forecast</span><br>
		...
		<div class="weather-item">
			...
			</div><span style="font-size:11px;font-weight:600;text-transform:uppercase;color:rgba(95,96,97,0.8)">Current Conditions</span><br>
			<div id="currentsky">
	...
	<div class="weather-container">
		<div class="weather-item">
			...
			</div><span style="font-size:11px;font-weight:600;text-transform:uppercase;color:rgba(95,96,97,0.8)">Wind Speed</span><br>
		...
		<div class="weather-item">
			...
			</div><span style="font-size:11px;font-weight:600;text-transform:uppercase;color:rgba(95,96,97,0.8)">Barometer</span><br>
		...
		<div class="weather-item">
			...
			</div><span style="font-size:11px;font-weight:600;text-transform:uppercase;color:rgba(95,96,97,0.8)">Wind Direction</span><br>
	...
	<div class="weather-container">
		<div class="weather-item">
			...
			</div><span style="font-size:11px;font-weight:600;text-transform:uppercase;color:rgba(95,96,97,0.8)">Rainfall Today</span><br>
			<div id="rainfall"></div>
		...
		<div class="weather-item">
			...
			</div><span style="font-size:11px;font-weight:600;text-transform:uppercase;color:rgba(95,96,97,0.8)">UV | <span style="color:#F26C4F">Solar Data</span></span><br>
			<div id="solar"></div>
		...
		<div class="weather-item">
			...
			</div><span style="font-size:11px;font-weight:600;text-transform:uppercase;color:rgba(95,96,97,0.8)"><span style="color:#66a1ba;">Earthquake</span> Data</span><br>
			<div class="updatedtime">
				<span>Updated</span> <?php echo $update;?>
			</div>
