...
<head>
  ...
  <script  src="js/jquery.js"></script>
   ...
   <script src="graphs/3dayweather.js"></script>
...
<div class="weather2-container">
  <div class="weather2-item" style="background-image:url(css/homepageicons/temp.png);background-repeat:no-repeat;background-position:bottom left;font-size:12px;">Temperature Indoor
  ...
  var refreshId = setInterval(indoor, 120000);      
   </script>    
  <div id="indoor" ><?php include_once('indoor.php');?></div></div>
  ...
  <div class="weather2-item" style="background-image:url(css/homepageicons/caution.png);background-repeat:no-repeat;background-position:bottom left;font-size:12px;">Notification Alerts
  <div class="indoorvalues">  
   <script async type="text/livescript">
  ...
  var refreshId = setInterval(notification, 26000);      
   ...
   <div id="notification" ><?php include_once('notification.php');?></div></div> 
   </div></div>
...
<div class="weather-container">
  ...
  var refreshId = setInterval(temperaturerefresh, 30000);
   </script>
  <div id="temperature"><?php include_once('temperature.php');?></div><br>
  </div></div></div></div>
...
<div class="weather-container">
  ...
  var refreshId = setInterval(refreshwind, 16100);
   ...
   <div id="windspeed"><?php include_once('windspeed.php');?></div>
...
<script async type="text/livescript">
  ...
  <div id="barometer"><?php include_once('barometer.php');?></div></div>
  </div>
  ...
  var refreshId = setInterval(windirection, 16200);      
   ...
   <div id="windirection"><?php include_once('windirection.php');?></div>     </div>           
         </div></div></div></div>
  </div>
</div>
...
<div class="weather-container">
  ...
  <div id="rain"><?php include_once('rainrate.php');?></div></div></div></div>
 ...
 <script async type="text/livescript">
    ...
    <div id="solar"><?php include_once('solar.php');?></div>
