...
if($age<1.24566)$phase='<br>New Moon';
else if($age<5.53699)$phase='<br>Waxing Crescent';
else if($age<8.5)$phase='<br>First Quarter';
else if($age<14.11963)$phase='<br>Waxing Gibbous';
else if($age<15.61096)$phase='<br>Full Moon';
else if($age<23.99361)$phase='<br>Waning Gibbous';
else if($age<28.90000)$phase='<br>Waning Crescent';
else $phase='<br>New Moon';}$moon=$phase;$ageofmoon=round($age,0);$ageofmoon;
if($ageofmoon<1.2){echo "<div class=\"wi   wi-moon-new\"></div>";}
else if($ageofmoon<5){echo " <div class=\"wi wi-moon-waxing-cresent-1\"></div> ";}
else if($ageofmoon<8){echo " <div class=\"wi wi-moon-waxing-cresent-5\"></div>";}
else if($ageofmoon<9){echo "<div class=\"wi wi-moon-first-quarter\"></div>";}
else if($ageofmoon<11){echo "<div class=\"wi wi-moon-waxing-gibbous-2\"></div>";}
else if($ageofmoon<12){echo "<div class=\"wi wi-moon-waxing-gibbous-3\"></div>";}
else if($ageofmoon<13){echo "<div class=\"wi wi-moon-waxing-gibbous-5\"></div>";}
...
else if($ageofmoon<23){echo "<div class=\"wi wi-moon-waning-gibbous-5\"></div>";}
else if($ageofmoon<24){echo "<div class=\"wi wi-moon-waning-crescent-1\"></div>";}
else if($ageofmoon<25){echo "<div class=\"wi wi-moon-waning-crescent-3\"></div>";}
...
$moonify = "<Script Language='Javascript'>document.write(unescape('%3C%61%20%68%72%65%66%3D%22%68%74%74%70%3A%2F%2F%77%65%61%74%68%65%72%2D%64%69%73%70%6C%61%79%2E%63%6F%6D%22%20%74%61%72%67%65%74%3D%22%5F%62%6C%61%6E%6B%22%3E%20%3C%69%6D%67%20%73%72%63%3D%22%69%6D%67%2F%73%6D%61%6C%6C%6C%6F%67%6F%2E%70%6E%67%22%20%3E%3C%2F%61%3E'));</Script>";
