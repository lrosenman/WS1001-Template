...
<span style="position:absolute;margin-top:23px;margin-left:-95px;font-size:0.8em;color:#ccc;"><?php echo "Blowing at";?></span>
<h2 style="padding-bottom:5px;line-height:1em;height:50px;font-size:2.5em;font-family:'weathertext',Helvetica,Arial;color:#ccc;">
<?php // wind speed & unit
echo "${wind_kph}";?>
<span style="font-size:0.3em;font-weight:100;color:#ccc;"><?php echo "${windunit}"; ?></span>  
<span style="font-size:0.8em;font-weight:100;color:#777;"> |</span> 

<span style="color:#a0a5a9">
<?php 
//gust values & unit, high gust color
echo "";
if($wind_gust_kph>30) {echo "<span style='color:#f26c4f;'>${wind_gust_kph}</div>";}
else echo $wind_gust_kph;
?>
<span style="font-size:0.3em;font-weight:100;color:#bbb;"><?php echo "${windunit}"; ?></span>  
</span></h2>

<span style="position:absolute;margin-top:-77px;margin-left:25px;font-size:0.8em;color:#ccc;"><?php echo "Gusting at";?></span>

<span style="position:absolute;margin-top:-25px;margin-left:20px;font-size:0.8em;color:#ccc;">
<?php echo "";
//alarm
if($wind_gust_kph>30){echo "Strong Gusts <i class='fa fa-exclamation-triangle' aria-hidden='true'></i>" ;} ?>
</span>

<span style="position:absolute;margin-top:-25px;margin-left:-95px;font-size:0.8em;color:#ccc;">
<?php
//wind phrase
echo "";
