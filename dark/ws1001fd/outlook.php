...
?> </span>Outlook Today & <span>Tomorrow</span></div>
   <!-- day outlook --->
   <section id='dayicon' style="background-repeat:no-repeat !important;margin-left:5px;margin-top:5px;color:#fff; ">
  <section id='day' style="margin-left:55px;z-index:1;color:#fff; "></section></section>
  <!-- night outlook --->
  <section id='nticon' style="background-repeat:no-repeat !important;margin-top:15px;margin-left:5px;color:#fff;  ">
  <section id='night' style="margin-left:55px;z-index:1;color:#fff; "></section></section></p>
   <section id='tomoicon' style="background-repeat:no-repeat !important;background-size:60px;margin-top:15px;margin-left:5px;color:#fff;  ">
  <section id='tomo' style="margin-left:55px;z-index:1;color:#fff; "></section></section></div></div></div></p>
