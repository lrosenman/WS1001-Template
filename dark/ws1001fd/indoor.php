...
if($temp_indoor>85){echo "<div class=\"\"></div><div class=\"indoortemptexthot\"> ${temp_indoor}<suptemp1>&deg;</suptemp1></div>";}
else if($temp_indoor>70){echo "<div class=\"\"></div><div class=\"indoortemptextcool\"> ${temp_indoor}<suptemp1>&deg;</suptemp1></div>";}
else if($temp_indoor<70){echo "<div class=\"\"></div><div class=\"indoortemptextcooler\"> ${temp_indoor}<suptemp1>&deg;</suptemp1></div>";}
?>   
...
if ($temp_indoor > $temp_indoortrend) {
    echo "<span style='color:#df826b;font-size:0.35em'><i class='wi wi-wind towards-45-deg'></i></span>";
}
