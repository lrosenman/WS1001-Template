...
<html>
	<head>
		...
		<![endif]-->
			...
			<div class="titleforecast"><i class="fa fa-map-marker1"></i><span style="color:#ccc; background: url(css/logos/graphlogo.png) left 10px bottom 10px no-repeat ;"> <?php
echo "${stationName} \n";
?><span style="color:#ccc">Forecast</span><span style="color:#59a6c2"> Ahead</span></div>
		<section id=wuforecasts style="font-weight:600;color:#ccc;"></section>
