    ...
    function a(a) {
        if (0 === typeof a.length) s("forecast");
            ...
            for (var e = 0; e < a.length; e++) {
				...
				n.conditions + "</span><br><br><span style=' color: #f26c4f !important;margin-left:17%;font-size:12px;line-height:12px;'> " + 
				n.high.celsius + "° <span style='color:#777;'> | <span style='color:#66a1ba;font-size:12px;'> " + n.low.celsius + "° <div class='rain'> <span style='color:#ccc;font-size:11px;font-weight:900;margin-left:17%;'> " + 
				...
				n.snow_allday.cm + " <span style='color:#66a1ba;font-size:11px;font-weight:900;'> cm <br><span style='color:#ccc;font-size:10px;margin-left:17%;'>" +
				n.maxwind.dir + " <span style='color:#ccc;font-size:11px;font-weight:400;'>" +  n.maxwind.kph + "</span> kmh " )
            }
    }
