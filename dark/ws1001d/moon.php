...
<div class="titleforecast"><span style="color:#ccc;font-size:1em;margin-left:120px;margin-top:25px;"><i class="fa fa-map-marker1 fa-1x"></i> <?php
echo "${stationName} \n";
...
<span style="color:#66a1ba;">&nbsp;Moonset:<span style="color:#ccc;font-weight:normal;">
