 ...
 <button class="button right"><a href="#"><img src="img/smalllogo.png" ></a></button>
    ...
    <nav class='menu'>
     ...
     <!--respect this line its not a lot to ask --->
      <span style="font-size:10px;background:#3d3d3d;border:none;padding:10px;border-radius:4px;"><?php echo "$moonify \n";?></span>
    </nav>
  </div>
...
<div class="weather-container">
  ...
  <span style="font-size:11px;font-weight:600;text-transform:uppercase;color:#ddd;">Temperature 
  ...
  <span style="font-size:11px;font-weight:600;text-transform:uppercase;color:#ddd;"><i class="fa fa-map-marker"></i>
...
?>Forecast</span><br />  
  ...
  <span style="font-size:11px;font-weight:600;text-transform:uppercase;color:#ddd;">Current Conditions</span><br />  
   <script async type="text/livescript">
...
<div class="weather-container">
  ...
  <span style="font-size:11px;font-weight:600;text-transform:uppercase;color:#ddd;">Wind Speed</span><br />
   <script async type="text/livescript">
  ...
  <span style="font-size:11px;font-weight:600;text-transform:uppercase;color:#ddd;">Barometer</span><br />
<script async type="text/livescript">
  ...
  <span style="font-size:11px;font-weight:600;text-transform:uppercase;color:#ddd;">Wind Direction</span><br />
  <script async type="text/livescript">
...
<div class="weather-container">
  ...
  <span style="font-size:11px;font-weight:600;text-transform:uppercase;color:#ddd;">Rainfall Today</span><br />
  <script async type="text/livescript">
  ...
  <span style="font-size:11px;font-weight:600;text-transform:uppercase;color:#ddd;">UV | <span style="color:#F26C4F">Solar Data</span></span><br />
 <script async type="text/livescript">
 ...
 <span style="color:#777;font-weight:600;"> Regional <span style="color:#F26C4F;"> & <span style="color:#66a1ba;">Significant  Earthquakes</span>
  ...
  <span style="font-size:11px;font-weight:600;text-transform:uppercase;color:#ddd;"><span style="color:#66a1ba;">Earthquake</span> Data</span><br />
