...
/*month*/
.maxrainfallmonth{position:absolute;border-radius:100%;height:60px;width:60px;padding:2px;float:right;
...
/*year*/
.maxrainfallyear{position:absolute;border-radius:100%;height:60px;width:60px;padding:2px;float:right;
border:1px solid #777;
margin-top:60px;
margin-left:-5px}
...
<div class="maxrainfallmonth-content" style="font-size:11px;color:#ccc;"><?php echo "${month}\n"; ?><br>
